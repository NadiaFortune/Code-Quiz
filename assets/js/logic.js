...
//     answerBtn1.textContent = questionSource[n].answers[0];
//     answerBtn2.textContent = questionSource[n].answers[1];
//     answerBtn3.textContent = questionSource[n].answers[2];
//     answerBtn4.textContent = questionSource[n].answers[3];
//     questionNumber = n;
// }
